...
public class DataBaseConfigurator {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		LocalSessionFactoryBuilder localSessionFactoryBuilder = new LocalSessionFactoryBuilder(
				dataSource);
		localSessionFactoryBuilder.addAnnotatedClasses(User.class, UserRole.class, Advert.class,
				AdvertType.class, Message.class);
	...
	public AdvertDAO getAdvertDao() {
		return new DefaultAdvertDao();
	}

	@Bean(name = "advertService")
	public AdvertService getAdvertService() {
		return new DefaultAdvertService();
	}

	@Bean(name = "advertTypeDAO")
	public AdvertTypeDAO getAdvertTypeDao() {
		return new DefaultAdvertTypeDao();
	}

	@Bean(name = "advertTypeService")
	public AdvertTypeService getAdvertTypeService() {
		return new DefaultAdvertTypeService();
	}
